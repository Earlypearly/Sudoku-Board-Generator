...
def checker():
    ...
    r1 = a1_int+a2_int+a3_int+b1_int+b2_int+b3_int+c1_int+c2_int+c3_int
    if r1 == 45:
        print("True")
    else:
        print("False")
    r2 = a4_int+a5_int+a6_int+b4_int+b5_int+b6_int+c4_int+c5_int+c6_int
    if r2 == 45:
        print("True")
    else:
        print("False")
    r3 = a7_int+a8_int+a9_int+b7_int+b8_int+b9_int+c7_int+c8_int+c9_int
    if r3 == 45:
        print("True")
    else:
        print("False")
    r4 = d1_int+d2_int+d3_int+e1_int+e2_int+e3_int+f1_int+f2_int+f3_int
    if r4 == 45:
        print("True")
    else:
        print("False")
    r5 = d4_int+d5_int+d6_int+e4_int+e5_int+e6_int+f4_int+f5_int+f6_int
    if r5 == 45:
        print("True")
    else:
        print("False")
    r6 = d7_int+d8_int+d9_int+e7_int+e8_int+e9_int+f7_int+f8_int+f9_int
    if r6 == 45:
        print("True")
    else:
        print("False")
    r7 = g1_int+g2_int+g3_int+h1_int+h2_int+h3_int+i1_int+i2_int+i3_int
    if r7 == 45:
        print("True")
    else:
        print("False")
    r8 = g4_int+g5_int+g6_int+h4_int+h5_int+h6_int+i4_int+i5_int+i6_int
    if r8 == 45:
        print("True")
    else:
        print("False")
    r9 = g7_int+g8_int+g9_int+h7_int+h8_int+h9_int+i7_int+i8_int+i9_int
    if r9 == 45:
        print("True")
    else:
        print("False")
    print("end1\n")
    r11 = a1_int+a4_int+a7_int+d1_int+d4_int+d7_int+g1_int+g4_int+g7_int
    if r11 == 45:
        print("True")
    else:
        print("False")
    r44 = b1_int+b4_int+b7_int+e1_int+e4_int+e7_int+h1_int+h4_int+h7_int
    if r44 == 45:
        print("True")
    else:
        print("False")
    r77 = c1_int+c4_int+c7_int+f1_int+f4_int+f7_int+i1_int+i4_int+i7_int
    if r77 == 45:
        print("True")
    else:
        print("False")
    r22 = a2_int+a5_int+a8_int+d2_int+d5_int+d8_int+g2_int+g5_int+g8_int
    if r22 == 45:
        print("True")
    else:
        print("False")
    r55 = b2_int+b5_int+b8_int+e2_int+e5_int+e8_int+h2_int+h5_int+h8_int
    if r55 == 45:
        print("True")
    else:
        print("False")
    r88 = c2_int+c5_int+c8_int+f2_int+f5_int+f8_int+i2_int+i5_int+i8_int
    if r88 == 45:
        print("True")
    else:
        print("False")
    r33 = a3_int+a6_int+a9_int+d3_int+d6_int+d9_int+g3_int+g6_int+g9_int
    if r33 == 45:
        print("True")
    else:
        print("False")
    r66 = b3_int+b6_int+b9_int+e3_int+e6_int+e9_int+h3_int+h6_int+h9_int
    if r66 == 45:
        print("True")
    else:
        print("False")
    r99 = c3_int+c6_int+c9_int+f3_int+f6_int+f9_int+i3_int+i6_int+i9_int
    if r99 == 45:
        print("True")
    else:
        print("False")
